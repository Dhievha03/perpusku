    ...
    <div class="card p-4 mb-4">
      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-md-6" style="text-align: right">
          <a href="{{ route('admin.book.exportPdf') }}" target="_blank" rel="noopener noreferrer" class="btn btn-danger">Export PDF</a>
          <a href="{{ route('admin.book.exportExcel') }}" target="_blank" rel="noopener noreferrer" class="btn btn-success">Export Excel</a>
...
<script>
  var dataTable = $('#data-table').DataTable({
      ...
      autoWidth: true,
      scrollX: true,
      ajax: "{{ route('admin.book.getBooks') }}",
      columns: [
      {
          data: 'DT_RowIndex',
          orderable: false,
  ...
  $('#category-filter').on('change', function () {
        ...
        dataTable.ajax.url("{{ route('admin.book.getBooks') }}?category=" + categoryId).load();
    });
</script>
@endsection
